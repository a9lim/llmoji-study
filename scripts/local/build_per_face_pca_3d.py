...
companion wrapper ``wrap_blog_3d_html.py`` extracts each scene
on-demand and exposes a model toggle for the blog post.

Usage:
    .venv/bin/python scripts/local/build_per_face_pca_3d.py
"""
...
# Match the v3 main lineup used by 31_v3_quadrant_procrustes.py.
...
MIN_FACE_COUNT = 1
OUT_HTML = FIGURES_DIR / "local" / "cross_model" / "fig_v3_per_face_pca_3d.html"
