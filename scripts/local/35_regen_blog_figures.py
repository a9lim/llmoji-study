...
Run after re-running `scripts/04_emotional_analysis.py` and
`scripts/21_v3_layerwise_emergence.py` for any model whose data has
...
Usage:
    .venv/bin/python scripts/35_regen_blog_figures.py
"""
