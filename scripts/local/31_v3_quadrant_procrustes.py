...
Usage:
  ...
  python scripts/local/31_v3_quadrant_procrustes.py
  # Subset (e.g. while v3 chain is still running):
  python scripts/local/31_v3_quadrant_procrustes.py --models gemma,qwen
  # Different reference:
  python scripts/local/31_v3_quadrant_procrustes.py --reference qwen

Output:
  figures/local/cross_model/fig_v3_quadrant_procrustes_3d.html
  figures/local/cross_model/v3_quadrant_procrustes_summary.json
"""
