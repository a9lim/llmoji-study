...
Outputs:
  data/local/face_gain_variance.tsv          (per-model summary)
  data/local/face_gain_variance_bootstrap.tsv (full distribution, all models)
  figures/local/fig_face_gain_variance.png
"""
...
def main() -> None:
    ...
    sum_path = DATA_DIR / "local" / "face_gain_variance.tsv"
    boot_path = DATA_DIR / "local" / "face_gain_variance_bootstrap.tsv"
