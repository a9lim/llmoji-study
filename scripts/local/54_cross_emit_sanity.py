...
Usage:
    python scripts/local/54_cross_emit_sanity.py
    python scripts/local/54_cross_emit_sanity.py --ground-truth-floor 1
...
def main() -> None:
    ...
    # Face origin from the parquet (any model's parquet has same metadata).
    ...
    out_tsv = DATA_DIR / "face_likelihood_cross_emit_sanity.tsv"
    ...
    out_md = DATA_DIR / "face_likelihood_cross_emit_sanity.md"
    out_md.write_text("\n".join(lines))
