...
blend of per-quadrant emission distribution.
  ...
  fig_v3_extension_3d_pca_per_face.html        — per-face aggregate
      ...
      layer (read from `MODEL_REGISTRY[short].preferred_layer`; under
      h_first that's gemma L50, qwen L59, ministral L20), fit
      independently per model from the cached
