...
Reads ``data/harness/claude_descriptions.jsonl`` (the flat HF-corpus output of
``scripts/60_corpus_pull.py``). For each canonical kaomoji, embeds
...
Usage:
    python scripts/62_corpus_embed.py [--device mps]
"""
